            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <form role="form" action="{{ route('machine.create') }}" method="post">
                                @csrf
                                <div class="form-group row mt-3">
                                    <h2 class="col-6 d-inline">Machine Name </h2>
                                    <div class="col-6">
                                        <input id="machine" type="text" name="machinename" autocomplete="off" placeholder="Enter Machine Name" id="exampleInputEmail2" class="form-control float-right">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!-- <select data-placeholder="Select Work Cell" id="workcell" class="chosen-select" name="workcell" tabindex="2"> -->
                                            <option value="">-- Select Work Cell --</option>
                                            <option value="workcella">Work Cell A</option>
                                            <option value="workcellb">Work Cell B</option>
                                            <option value="workcellc">Work Cell C</option>
                                        </select>
...
<script src="{{ url('assets/js/custom/macr.js') }}"></script>
