...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Part Number Production Report</h2>
    </div>
    <div class="col-lg-2">
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Part Number Production Report</h5>                    
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-2 col-md-3 col-sm-4 col-xs-3">
                            <label class="font-normal">Part Number</label>
                            <select id="part_number" data-placeholder="Select Part Number..." class="chosen-select"  tabindex="2">
...
<script>
    var url_part = '{{ route("report.partnumber") }}';
</script>
<script src="{{ url('assets/js/custom/part.js') }}"></script>
